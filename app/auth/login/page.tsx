  ...
  return (
    <div className="reveal">
      ...
      <a
        ...
        className="flex items-center justify-center gap-2.5 w-full font-sans text-[14px] font-medium py-3 bg-white text-zinc-900 rounded-lg hover:bg-zinc-100 transition-all duration-300 border border-edge/20"
      >
